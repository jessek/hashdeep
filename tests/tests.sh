...
do 
 ...
 6) $BASE/md5deep -k    /tmp/test/deadbeef.txt         > /tmp/test$i.out ;;
 7) $BASE/md5deep -i1000 -r /tmp/test                  > /tmp/test$i.out ;;
 8) $BASE/md5deep -I1000 -r /tmp/test                  > /tmp/test$i.out ;;
 9) $BASE/hashdeep -r   /tmp/test                      > /tmp/test$i.out ;;
 10) $BASE/hashdeep -p512 -r /tmp/test                    > /tmp/test$i.out ;;
 11) $BASE/md5deep  -p512 -r /tmp/test                    > /tmp/test$i.out ;;
 12) $BASE/sha1deep -p512 -r /tmp/test                    > /tmp/test$i.out ;;
 13) $BASE/sha256deep -r /tmp/test                     > /tmp/test$i.out ;;
 14) $BASE/tigerdeep  -r /tmp/test                     > /tmp/test$i.out ;;
 15) $BASE/whirlpooldeep -r /tmp/test                  > /tmp/test$i.out ;;
